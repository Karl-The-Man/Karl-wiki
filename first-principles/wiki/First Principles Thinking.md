...
A reasoning method that decomposes a problem to its most fundamental, independently verifiable truths (axioms), then builds conclusions upward from those truths. Contrasted with [[Reasoning by Analogy]], which copies or adapts what has been done before.
...
[[Elon Musk]] traces the method to how physicists work: they discover counterintuitive phenomena (like quantum mechanics) by reasoning from the ground up rather than from precedent. He considers the "mental tools of physics" the best general-purpose thinking tools available.

## How to Apply

1. **Identify the axiomatic base** — What truths am I most confident in? (e.g., conservation of energy, raw material costs on commodity exchanges)
2. **Reason upward** — Construct conclusions from those truths, ignoring historical precedent or convention.
3. **Check against axioms** — Does the conclusion violate any foundational truth? If yes, discard it.
4. **Compare to current reality** — How far is the existing solution from the theoretical optimum?

## Case Studies

### Battery Costs at [[Tesla]]
Industry assumed EV batteries would always cost ~$600/kWh. Musk decomposed to raw materials (cobalt, nickel, aluminum, carbon, polymers, steel can), priced them on the London Metal Exchange at ~$80/kWh, and concluded radical cost reduction was achievable with better manufacturing. *(elon-musk-on-first-principles.pdf)*

### Rocket Costs at [[SpaceX]]
Raw materials for a rocket (aluminum, titanium, copper, carbon fiber) cost 1–2% of the finished rocket. The gap revealed massive manufacturing inefficiency. This analysis led to the [[Idiot Index]] as a general diagnostic and to SpaceX's strategy of vertical integration and manufacturing innovation. The "magic wand number"—what the rocket would cost if atom rearrangement were free—set the theoretical floor. *(elon-musk-on-first-principles.pdf)*
