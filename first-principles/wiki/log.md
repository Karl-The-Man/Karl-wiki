...
Wiki structure created. Directories: `raw/`, `raw/assets/`, `wiki/`. Schema defined in `CLAUDE.md`. Ready for first ingest.
Pages created: [[index]], [[log]]

## [2026-04-10] ingest | Elon Musk on First Principles
Ingested `raw/assets/elon-musk-on-first-principles.pdf` — a compiled extract of Musk quotes on physics-based reasoning, first-principles thinking, truth-seeking, and manufacturing heuristics, drawn from 80+ footnoted interviews, podcasts, and books.
Pages created: [[Elon Musk on First Principles]], [[Elon Musk]], [[SpaceX]], [[Tesla]], [[The Boring Company]], [[Douglas Adams]], [[First Principles Thinking]], [[Reasoning by Analogy]], [[Idiot Index]], [[Thinking in Limits]], [[Obsession with Truth]], [[Wishful Thinking]], [[Semantic Tree of Knowledge]], [[Philosophy of Curiosity]]
Pages updated: [[index]], [[overview]], [[log]]

## [2026-04-10] ingest | Jensen Huang on First Principles Thinking
